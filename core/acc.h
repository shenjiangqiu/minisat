    ...
    int start_sim()
    {
        ...
        while (!m_event_queue.empty())
        {
            ...
            case EventType::ProcessWatcherList:
            {
                ...
                auto modified_list = value->get_modified();
                ...
                { // this clause access is generated by this event
                    clause_waiting_queue.push(std::make_pair(lower->first, lower->second));
                }
            ...
            case EventType::ProcessClause:
            {
                ...
                if (value->get_generated_conf() == event_value.index)
                {
                    return end_time; //we already finished!
                }
                if (value->get_generated_assignment().find(event_value.index) != value->get_generated_assignment().end())
                {
                    auto generated_assignments = value->get_generated_assignment()[event_value.index];
